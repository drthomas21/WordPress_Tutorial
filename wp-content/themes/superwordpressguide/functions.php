...
add_action("wp",function() {
    ...
    wp_register_script("bootstrap",get_asset_url("js/bootstrap.min.js"),array("jquery","popper"),"4.0.0",true);
    ...
    //WP Enqueue Styles
    wp_register_style("boostrap",get_asset_url("css/bootstrap.min.css"),array(),"4.0.0","all");
