<section class="homepage blog-header">
    <div class="main-content row">
        <div class="col-md-12 col-lg-8">
            <div class="col-xl-6 main-content-1 float-left">
            ...
            <div class="col-xl-6 posts main-content-2 float-right">
                ...
                <div class="post" ng-repeat="Post in latestPosts | limitTo:1">
                    ...
                    <div class="post-info row">
                        ...
                        <div class="col-sm-6 text-right"><small ng-bind-html="Post.human_time"></small></div>
                    </div>
                    <div class="row">
        ...
        <div class="posts col-sm-12 row">
            ...
            <div class="col-lg-4 col-md-12" ng-repeat="Post in opEdPosts">
                <div class="post-header row">
                    <h2 class="col-sm-12">
                        <a ng-href="{{Post.permalink.href}}" ng-attr-alt="{{Post.permalink.alt}}" ng-bind="Post.permalink.label"></a>
                    </h2>
        ...
        <div class="posts more-posts col-sm-12 row">
            ...
            <div class="col-lg-4 col-md-12" ng-repeat="Post in latestPosts" ng-hide="$first">
                <div class="col-sm-12">
                    <div class="post-header row">
                        <h2 class="col-sm-12">
                            <a ng-href="{{Post.permalink.href}}" ng-attr-alt="{{Post.permalink.alt}}" ng-bind="Post.permalink.label"></a>
